...
| 13 | Light evidence | Version 1.0.5 gains come from less parse, patch, and layout drift. |
...
- `/streaming-performance-evidence.json` for benchmark-derived text already encoded in the slide.
